...
from resources.books import BookInfoResource, UserReviewsResource, UserFavoritesResource, FavoriteResource
...
def create_routes():
    ...
    api.add_resource(FavoriteResource, "/api/favorites/<string:book_id>")
